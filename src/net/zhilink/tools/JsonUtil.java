...
public class JsonUtil {
	...
	public static String beanToJson(Object bean) {
		...
		return beanToJson(bean,null,false);
	...
	public static String mapToJson(Map<String, ?> map, String[] _nory_changes,
		...
		for (Iterator<?> it = key.iterator(); it.hasNext();) {
			...
			} else if (map.get(s) instanceof Long
					|| map.get(s) instanceof String
					|| map.get(s) instanceof Double
					|| map.get(s) instanceof Integer) {
				String str = map.get(s).toString();
				s_json += (s + ":" + str);
			} else {
				JSONObject json = JSONObject.fromObject(map.get(s));
