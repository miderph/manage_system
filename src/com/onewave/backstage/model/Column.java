...
public class Column implements Serializable {
	...
	private String import_rule_ids;

	public String getImport_rule_ids() {
		return import_rule_ids;
	}

	public void setImport_rule_ids(String importRuleIds) {
		import_rule_ids = importRuleIds;
	}
