...
begin
   ...
   loop
      update zl_img set (
            ...
            from ZL_CONT_SALES_IMPORT im2 where im2.c_id=zl_img.target_id
         )
   ...
   loop
      update zl_cont set (
            ...
            v_sales_type,NAME,case when zl_cont.status=11 then 11 else 10 end status, CREATE_TIME,MODIFY_TIME,sysdate-1,sysdate+3650
