...
select
   ...
   ,usergroup_ids_mac,usergroup_ids_zone,usergroup_ids_model,usergroup_ids_channel
   ,usergroup_ids_mac2,usergroup_ids_zone2,usergroup_ids_model2,usergroup_ids_channel2
from zl_menu menu
