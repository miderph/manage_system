...
select cc.id version_id,rownum row_num, cc.VERSION_NUM,cc.SOFTWARE_INFO,cc.PLAT,cc.ENFORCE_FLAG,cc.DESCRIPTION,cc.PUBLISH_TIME,cc.VER_MAIN,cc.VER_SUB,cc.VER_DEPLOY,cc.VER_BUILD
,cc.usergroup_id,cc.status,url.id url_id,url.version,url.version_code,url.download_url,url.url_type,url.upgrade_temp_url,url.temp_url_expire_time,url.share_password
,apk_md5sum
