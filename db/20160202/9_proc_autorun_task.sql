...
begin
  ...
  if v_taskid > 0 then
     ...
     elsif v_proc_name = 'proc_import_sales_deal' then
         proc_import_sales_deal(v_param1,v_param2);
     elsif v_proc_name = 'proc_import_app_deal' then
         proc_import_app_deal(v_param1,v_param2);
     end if;
