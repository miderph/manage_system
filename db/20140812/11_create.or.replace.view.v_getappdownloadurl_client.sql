...
select app.c_id ,app.app_name name ,app.version,app.version_code ,url.id url_id,url.md5sum
  ,url.download_url,url.url_type,url.upgrade_temp_url,url.temp_url_expire_time,url.share_password
